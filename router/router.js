...
router.post("/register", async (req, res) => {
    ...
    try {
        ...
        console.log("error for registration time" + error.message);
...
router.post("/addcart/:id", authenicate, async (req, res) => {
    ...
    try {
        ...
        console.log(Usercontact + "user already exists");
        ...
        if (Usercontact) {
            ...
            console.log(cartData + " these saves wait");
            console.log(Usercontact + "usercode save");
...
router.get("/validuser", authenicate, async (req, res) => {
    try {
        ...
        console.log(validuserone + "user home header main");
